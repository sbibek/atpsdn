...
//            return (tcp.getSourcePort() == 9090) || (tcp.getDestinationPort() == 9092);
//        }
//
//        @Override
...
//                    if (session.isDirectionSenderToReceiver(ip, tcp) && tcp.getPayload().serialize().length != 0) {
//                        manager.process(tcp.getPayload().serialize());
//                        System.out.println("so far, the manager found the length of "+manager.totalMessages);
